...
export const getSubjectTheme = (subject: Subject) => {
  switch (subject) {
    ...
    case 'Variado': return { bg: 'bg-[var(--bg)]', text: 'text-[var(--text)]', node: 'bg-[var(--math)] border-[var(--math-s)]', activeTab: 'bg-[var(--danger)]', line: 'bg-[var(--gray)]', iconBg: 'bg-yellow-500 text-slate-900', accentBg: 'bg-yellow-500/15 dark:bg-yellow-500/20', textHeading: 'text-yellow-600 dark:text-yellow-400' };
    default: return { bg: 'bg-[var(--bg)]', text: 'text-[var(--text)]', node: 'bg-[var(--math)] border-[var(--math-s)]', activeTab: 'bg-[var(--math)]', line: 'bg-[var(--gray)]', iconBg: 'bg-[var(--math)] text-white', accentBg: 'bg-sky-500/15 dark:bg-sky-500/20', textHeading: 'text-sky-600 dark:text-sky-400' };
  }
};
